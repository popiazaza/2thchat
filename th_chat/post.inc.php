...
DB::query("INSERT INTO " . DB::table('newz_data') . " (`uid`,`touid`,`icon`,`text`,`time`,`ip`,`unread`) VALUES ('$uid','$touid','$icon','$text','" . TIMESTAMP . "','$ip','$unread')");
